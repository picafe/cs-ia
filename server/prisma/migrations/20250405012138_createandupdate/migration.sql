/*
  ...
  - Added the required column `updatedAt` to the `StudentUser` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updatedAt` to the `TeacherUser` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "StudentUser" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;

-- AlterTable
ALTER TABLE "TeacherUser" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
