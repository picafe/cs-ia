...
export async function validatePasswordResetSessionRequest(req: Request, res: Response): Promise<PasswordResetSessionValidationResult> {
...
export function setPasswordResetSessionTokenCookie(context: Response, token: string, expiresAt: Date): void {
