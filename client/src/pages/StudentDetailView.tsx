  ...
  export default function StudentDetailView() {
    ...
    useEffect(() => {
      const fetchStudentData = async () => {
        try {
          setLoading(true);
          const res = await axios.get(`${serverUrl}/student/${studentId}/details`, {
        ...
        <Paper withBorder p="md" mb="md">
          <Group mb="md">
            ...
            <Group>
              ...
              <Text fw={500}>
                {studentData.totalHours.toFixed(1)}/{studentData.requiredHours} hours
              </Text>
            </Group>
          </Group>
          ...
          <Paper p="xl" withBorder>
            <Stack align="center" gap="md">
              ...
              <Text size="sm" ta="center">
                The student hasn't logged any activities. Activities will appear here once the student starts logging their work.
              </Text>
            </Stack>
          </Paper>
        )}
