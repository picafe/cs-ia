...
import { ActionIcon, Avatar, Group, Text, useComputedColorScheme, useMantineColorScheme } from '@mantine/core';
      ...
      <nav className={classes.navbar}>
        ...
        <div className={classes.footer}>
          ...
          <Group gap={6} className={classes.display}>
            <Avatar color="initials" radius="xl" size={28}>{user?.name.split(" ").map((word) => word.charAt(0).toUpperCase())}</Avatar>
