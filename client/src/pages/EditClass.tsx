  ...
  export default function EditClass() {
    ...
    const form = useForm({
      ...
      validate: {
        ...
        courseCode: (value) => (value.length > 20 ? "Course code must be under 20 characters" : null),
        description: (value) => (value.length > 500 ? "Description must be under 500 characters" : null),
      },
    });
